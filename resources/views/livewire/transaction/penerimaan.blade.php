            ...
            @auth
                <div>
                    ...
                    <p class="text-blue-100 text-sm">
                        Daftar penerimaan barang dari pengadaan
                    </p>
            ...
            <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl border border-indigo-50">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-gray-800">Daftar Penerimaan</h2>
                            <p class="text-xs text-gray-500">Data diambil dari views_penerimaan</p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-full text-sm">
                        <thead>
                            <tr class="bg-indigo-50 text-indigo-900 text-xs uppercase tracking-wide">
                                <th class="px-3 py-2 text-left rounded-l-lg">ID Penerimaan</th>
                                <th class="px-3 py-2 text-left">Tanggal</th>
                                <th class="px-3 py-2 text-left">ID Pengadaan</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($penerimaanList as $item)
                                <tr class="hover:bg-indigo-50/40">
                                    ...
                                    <td class="px-3 py-2 text-center space-x-2">
                                        <a href="{{ route('transaction.penerimaan.detail', $item->idpenerimaan) }}"
