...
<body
    class="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-600 min-h-screen flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md mx-auto">
        ...
        <div class="text-center mb-8">
            <div
                class="flex items-center justify-center gap-3 bg-white rounded-full shadow-lg px-6 py-2 w-fit mx-auto mb-4">
                <img src="https://cdn-icons-png.flaticon.com/512/2966/2966487.png" alt="RSHP Logo"
            ...
            <form wire:submit.prevent="login" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="username" wire:model="username" type="username"
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    <a href="{{ route('password.request') }}" class="text-blue-600 hover:text-blue-800 font-medium">Lupa
                        password?</a>
                </div>
