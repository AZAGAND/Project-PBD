<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div class="max-w-7xl mx-auto px-6 py-6">
            <div class="flex justify-between items-center">
                ...
                <div class="text-right">
                    ...
                    <p class="text-white font-semibold text-lg">Administrator</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        {{-- Flash Messages --}}
        @if (session()->has('ok'))
            <div class="mb-6 bg-white border-l-4 border-emerald-500 rounded-r-xl shadow-lg p-5 flex items-start space-x-4 animate-bounce">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-8 h-8 bg-indigo-100 rounded-lg flex items-center justify-center">
                                                <span class="text-indigo-700 font-bold text-sm">{{ $r->idrole }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center shadow-md">
                                                <span class="text-white font-bold text-sm">{{ strtoupper(substr($r->nama_role, 0, 2)) }}</span>
                                            </div>
                                            <div>
                                                <p class="text-sm font-semibold text-gray-900">{{ $r->nama_role }}</p>
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-16">
                                        <div class="text-center">
                                            ...
                                            <p class="text-sm text-gray-500">Silakan tambahkan role baru menggunakan form di samping</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
