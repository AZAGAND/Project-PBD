        ...
        <div class="max-w-6xl mx-auto px-6 py-8 space-y-8">
            ...
            <section class="bg-white rounded-2xl shadow-xl border-t-4 border-blue-600 p-6">
                <div class="flex items-center space-x-3 mb-5">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-800">{{ $isEdit ? 'Edit Vendor' : 'Tambah Vendor' }}</h2>
                        <p class="text-xs text-gray-500">{{ $isEdit ? 'Perbarui data vendor' : 'Tambah vendor baru' }}</p>
                    </div>
                </div>

                <form wire:submit.prevent="{{ $isEdit ? 'update' : 'store' }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    {{-- Nama Vendor --}}
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Nama Vendor <span class="text-rose-500">*</span></label>
            ...
            <section class="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-indigo-600">
                <div class="bg-gradient-to-r from-indigo-50 to-blue-50 px-6 py-5 border-b border-gray-200 flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-800">Data Vendor</h2>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-100">
                                ...
                                <th class="px-4 py-3 border-b-2 border-gray-200 text-left font-bold text-xs text-gray-700 uppercase">Badan</th>
